...
export default function SponsorCard({
  ...
  return (
    ...
    >
      <div className="relative flex h-56 w-48 flex-col justify-between rounded-[calc(1.5rem-3px)] bg-blue-950 p-4 transition-all duration-300 group-hover:bg-blue-900">
