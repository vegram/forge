...
export default function About() {
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center p-2">
      ...
      <p
        ref={textRef}
        className="font-poppins w-full max-w-[1276px] transform px-4 text-center text-[15px] font-semibold leading-[24px] tracking-[0.05em] text-white md:text-[30px] md:leading-[54px]"
      >
