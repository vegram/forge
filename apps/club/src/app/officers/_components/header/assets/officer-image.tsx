  ...
  return (
    ...
    <div className="flex h-64 w-52 items-center justify-center overflow-hidden">
      <div className="group relative h-52 w-40">
        {/* Background content */}
        <div
          className="border-box border-1 ease-slow pointer-events-none relative h-full w-full overflow-hidden rounded-xl border bg-background transition-all duration-500 group-hover:!transform-none dark:border-zinc-700"
          style={{
        ...
        <div
          className={cn(
            "border-box ease-slow pointer-events-none absolute inset-0 h-full w-full rounded-xl border-[6px] bg-white transition-all delay-75 duration-500 group-hover:!transform-none group-hover:opacity-0 dark:bg-gray-800",
            {
